...
function createTextSection() {
  ...
  p1.append('Um ', createElement('strong', { class: 'destaque' }, 'Desenvolvedor Front-End'), ' que une o rigor da lógica estruturada à eficiência das interfaces modernas.');
  const p2 = createElement('p', { class: 'apresentacao__conteudo__texto' });
  p2.append('Minha trajetória na tecnologia é marcada por uma base de engenharia profunda. Antes de focar na experiência do usuário, consolidei meu raciocínio lógico e a resolução de problemas complexos através de linguagens de baixo nível como ', createElement('strong', { class: 'destaque' }, 'C e C++'), '. Essa bagagem me permite entender exatamente o que acontece por trás dos panos de uma aplicação, resultando em um código nativo (', createElement('strong', { class: 'destaque' }, 'JavaScript, HTML5 e CSS3'), ') muito mais sólido, semântico e performático.');
  const p3 = createElement('p', { class: 'apresentacao__conteudo__texto' });
  p3.append('Graduado em ', createElement('strong', { class: 'destaque' }, 'Análise e Desenvolvimento de Sistemas (ADS)'), ' e com histórico prático no ', createElement('strong', { class: 'destaque' }, 'Banco do Brasil'), ' manipulando bancos de dados relacionais (SQL) e relatórios, desenvolvi uma visão analítica sobre a organização e o fluxo de dados. Hoje, aplico essa disciplina na construção de layouts responsivos, modulares e pautados em ', createElement('strong', { class: 'destaque' }, 'Acessibilidade Web (WCAG)'), ', enquanto expando continuamente meus horizontes com o estudo e aprimoramento ativo no ecossistema ', createElement('strong', { class: 'destaque' }, 'React e TypeScript'), '.');
  const p4 = createElement('p', { class: 'apresentacao__conteudo__texto' });
  p4.append('Além disso, sou um entusiasta de ', createElement('strong', { class: 'destaque' }, 'Inteligência Artificial'), ', integrando ferramentas inteligentes para otimizar meu fluxo de desenvolvimento e elevar a precisão das minhas entregas. Sou movido por desafios arquiteturais e pela evolução técnica constante. Vamos construir algo incrível juntos?');
